...
class LocationHelper: NSObject, ObservableObject, CLLocationManagerDelegate{
    ...
    deinit { self.locationManager.stopUpdatingLocation() }
    ...
    func doReverseGeocoding(location : CLLocation, completionHandler: @escaping(Address?, NSError?) -> Void){
